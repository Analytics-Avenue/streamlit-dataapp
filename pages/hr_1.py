...
dict_rows = [
    ...
    {"Column": "Stage_Offer", "Description": "Offer stage timestamp/flag"},
    {"Column": "Stage_Join", "Description": "Joining stage timestamp/flag"},
    {"Column": "Current_Stage", "Description": "Latest stage reached"},
    {"Column": "Days_in_Stage", "Description": "Days spent in current stage"},
    {"Column": "Total_Time_to_Hire_Days", "Description": "Days from apply to join"},
    {"Column": "Offer_Accepted_Flag", "Description": "1 if offer accepted"},
    {"Column": "Screen_Score", "Description": "Screening score"},
    {"Column": "Resume_Score", "Description": "Resume match score"},
    {"Column": "Recruiter_ID", "Description": "Recruiter handling the case"},
    {"Column": "JD_Variant", "Description": "Job description variant"},
