...
logo_url = "[https://raw.githubusercontent.com/Analytics-Avenue/streamlit-dataapp/main/logo.png](https://raw.githubusercontent.com/Analytics-Avenue/streamlit-dataapp/main/logo.png)"
st.markdown(f"""
...
try: return {"handle_unknown":"ignore","sparse_output":False}
except TypeError: return {"handle_unknown":"ignore","sparse":False}
...
with tab_insights:
    ...
    df = st.session_state.get("hospital_master")
    if df is None: st.info("Load dataset first."); st.stop()
    # simple example: top 5 hospitals by revenue
    insights=[]
