...
# -------------------------
sector_overview = {
    "Marketing Analytics": "Analyze customer journeys, optimize ad spends, improve campaign ROAS, and track funnel drop-offs. Use segmentation, forecasting, and attribution insights to supercharge marketing performance. Gain a unified 360-degree view of customers across channels for smarter decisions.",
    "Real Estate Analytics": "Understand locality demand, analyze pricing trends, compare property attributes, and forecast ROI. Leverage geospatial intelligence and ML models to identify high-growth micro-markets. Support investment decisions using rental yield and accurate price prediction analytics.",
    "Health Care Analytics": "Improve patient flow, predict OPD/ER volumes, enhance doctor allocation, and reduce waiting times. Use forecasting, classification, and EMR/EHR data to optimize hospital operations. Boost care quality with real-time monitoring and clinical performance analytics."
}
...
sectors = {
    ...
    "Real Estate Analytics": [
        ...
        {"name":"Real Estate Intelligence — Hybrid Dashboard","page":"realestate.py"},
    ],
...
# -------------------------
    ...
    with st.sidebar:
        ...
        for s in sector_overview.keys():
            if s != sector_name and st.button(f"➡ {s}"):
    ...
    for row in rows:
        cols = st.columns(len(row))  # Handle last row with <3 projects
